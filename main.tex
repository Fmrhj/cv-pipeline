...
\begin{document}
	...
	\begin{tabular}{L!{\VRule}R}
		...
		\footnotesize{Berlin, Germany}&\\[-12pt]
		& Speaker at the Airline Revenue Management on the Pricing \& Revenue Management stream. \href{https://www.dropbox.com/home/Aplicaciones/cv-pipeline?preview=OR+2017.pdf}{Presentation}.\\[7pt]
	...
	\begin{tabular}{L!{\VRule}R}
		...
		04/2014 - 06/2017 & \textbf{A  stochastic  dynamic  pricing  model  for  passenger air transportation} - OR 2017\\
		\footnotesize{Berlin, Germany}&\\[-12pt]
